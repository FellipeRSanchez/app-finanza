    ...
    <div className="max-w-[1200px] mx-auto flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
        ...
        <div className="flex flex-col gap-6">
          <Card className="flex flex-col bg-card-light dark:bg-[#1e1629] rounded-xl border border-border-light dark:border-white/10 shadow-soft overflow-hidden h-full">
          ...
          <Card className="p-6 bg-card-light dark:bg-[#1e1629] border border-border-light dark:border-white/10 shadow-soft gap-4 flex flex-col">
            <div>
